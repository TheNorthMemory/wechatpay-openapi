...
interface Jsapi
{
    ...
    /**
     * JSAPI场景预约扣费类型签约的预签约(异步模式)
     * @param array<string,mixed> $options
     * @link https://pay.weixin.qq.com/docs/partner/apis/entrusted-payment/partner/partner-jsapi-scheduled-deduct-pre-sign.html#async
     */
